"""
This is a comment in python.  We can make comments span mutliple lines
by enclosing our text in triple qutoes.
...
True if the string is a palidrome and False otherwise.
