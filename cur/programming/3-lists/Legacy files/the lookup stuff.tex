The list of triples can be used to pull the right information out of a list of 9 numbers. But how? There is more than one way. Start by recalling how you could pull a single piece of information out of a list.

Given a list of 9 numbers, how can you report only the 4th number? 

Given a list of 9 numbers, how can you report only the 4th and 5th numbers?

Given square with 9 numbers and locations with 3 numbers, write a reporter lookup that returns a new list of the numbers in square at the positions given in locations.
